...
df = pd.read_csv("../csv_files/convergence/conv_burger_ssp.csv")
...
plt.legend()
plt.savefig("convergence_plot_burger_all.pdf")
plt.close()
...
plt.grid(True, which="both", linestyle="--")
plt.legend()
plt.savefig("convergence_plot_burger_first_order.pdf")
plt.close()
...
plt.grid(True, which="both", linestyle="--")
plt.legend()
plt.savefig("convergence_plot_burger_tvd.pdf")
plt.close()
...
plt.grid(True, which="both", linestyle="--")
plt.legend()
plt.savefig("convergence_plot_burger_weno.pdf")
plt.close()
